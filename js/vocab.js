                              ...
                              <div class="kanji-each-contain">
                                  <div class="kanji-group-box">
                                      ...
                                      <div class="icon">
                                          ...
                                          <button onClick="deleteStoredKanji('${
                                            kanjiItem._id
                                          }')"><i class="fa-regular fa-trash-can"></i></button>
                                      </div>
                                  </div>
                                  <div class="view-kanji"><p>${
                                    kanjiItem.story
                                  }</p></div>
                              </div>
                          `;
...
const view_kanji = document.querySelector(".kanji-group-box");
const view = document.querySelector(".view-kanji");

if (view_kanji && view) {
  view_kanji.addEventListener("click", function () {
